...
class WebpackConfig {
  ...
  build() {
    return [
      Object.assign({}, this.rendererDefault, this.config.renderer),
      Object.assign({}, this.mainDefault, this.config.main)
    ]
  }
  ...
  buildSettings() {
    const json = require(bozon.sourcePath('package.json'))
