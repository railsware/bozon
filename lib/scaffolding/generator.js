...
class Generator {
  ...
  copyTemplates() {
    ...
    this.copyTpl($('stylesheets', 'application.css'), $('src', 'renderer', 'stylesheets', 'application.css'))
    this.copyTpl($('javascripts', 'renderer.js'), $('src', 'renderer', 'javascripts', 'index.js'))
