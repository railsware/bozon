...
class Generator {
  ...
  createDirectories() {
    ...
    this.mkdir(this.name, 'src', 'images')
    this.mkdir(this.name, 'src', 'stylesheets')
    this.mkdir(this.name, 'src', 'javascripts')
    this.mkdir(this.name, 'src', 'javascripts', 'main')
    this.mkdir(this.name, 'src', 'javascripts', 'renderer')
  ...
  copyTemplates() {
    ...
    this.copyTpl('index.html', $('src', 'index.html'))
    this.copyTpl($('json', 'production_package.json'), $('src', 'package.json'), this.defaults)
    this.copyTpl($('stylesheets', 'application.css'), $('src', 'stylesheets', 'application.css'))
    this.copyTpl($('javascripts', 'main.js'), $('src', 'javascripts', 'main', 'index.js'))
    this.copyTpl($('javascripts', 'renderer.js'), $('src', 'javascripts', 'renderer', 'index.js'))
    ...
    this.copyTpl($('test', 'main_spec.js'), $('test', 'features', 'main_spec.js'))
