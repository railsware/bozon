...
var Generator = function (name, options) {
  date = new Date()
  this.setName(name)
  this.defaults.year = date.getFullYear()
  this.options = options
  this.appDir = path.join(process.cwd(), this.uname)
}
...
Generator.prototype.setupDirs = function () {
  mkdir(this.uname)
  mkdir(this.uname, 'app')
  mkdir(this.uname, 'app', 'images')
  mkdir(this.uname, 'app', 'stylesheets')
  mkdir(this.uname, 'app', 'javascripts')
  mkdir(this.uname, 'app', 'javascripts', 'main')
  mkdir(this.uname, 'app', 'javascripts', 'renderer')
  mkdir(this.uname, 'config')
  mkdir(this.uname, 'config', 'environments')
  mkdir(this.uname, 'config', 'platforms')
  mkdir(this.uname, 'spec')
}
